...
if iris_file is None:
    rf_pickle = open('../../../../Downloads/Streamlist_iris/Streamlist_iris/02_iris_ml/random_forest_iris.pickle', 'rb')
    map_pickle = open('../../../../Downloads/Streamlist_iris/Streamlist_iris/02_iris_ml/output_iris.pickle', 'rb')
